  ...
  return (
    <div className="hidden sm:flex flex-col p-2 xl:items-start fixed h-full">
        ...
        <div className="hoverEffecttext-gray-700 flex items-center justify-center xl:justify-start mt-auto">
          <Image  src="https://cdn.shopify.com/s/files/1/0467/5878/9279/products/2_da0f83d1-d83f-4209-836e-306ddbbd7845.jpg" alt="error" className="h-10 w-10 rounded-full xl:mr-2"/>
          <div className="">
